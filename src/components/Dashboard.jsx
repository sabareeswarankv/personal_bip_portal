...
export default function Dashboard({ courses, history, onSelectCourse, onToggleCreator, isAdmin, onDeleteCourse, onEditCourse, onDeleteHistory, user }) {
    ...
    <div className="w-full px-6 md:px-12 py-8">
      ...
      <div className="mb-12">
        <div className="flex justify-between items-center mb-6">
          ...
          {/* Only show Add Course button if logged in as Admin */}
          {isAdmin && (
            <button 
